...
def application_kit_to_dict(kit: ApplicationKit) -> dict[str, Any]:
    ...
    return {
        ...
        "pramana_version": kit.pramana_version,
        "rachana_version": kit.rachana_version,
...
def application_kit_from_dict(data: dict[str, Any]) -> ApplicationKit:
    ...
    return ApplicationKit(
        ...
        pramana_version=str(data.get("pramana_version", "")),
        rachana_version=str(data.get("rachana_version", "")),
