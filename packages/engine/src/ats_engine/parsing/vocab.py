...
VOCABULARY: Final[tuple[VocabularyEntry, ...]] = (
    ...
    _entry("active directory", aliases=("microsoft active directory",), category="operations_support"),
    _entry("windows server", aliases=("microsoft windows server",), category="operations_support"),
    _entry("microsoft 365", aliases=("m365", "office 365"), display="Microsoft 365", category="productivity"),
    _entry("vmware", aliases=("vmware hosts",), display="VMware", category="platform"),
    _entry("virtualization", aliases=("virtualisation",), category="platform", kind="methodology"),
    _entry("backups", aliases=("backup",), category="operations_support", kind="skill"),
    _entry("helpdesk", aliases=("help desk",), category="operations_support", kind="skill"),
    _entry("networking", aliases=("network administration",), category="operations_support", kind="skill"),
    _entry("dns", display="DNS", category="operations_support"),
    _entry("dhcp", display="DHCP", category="operations_support"),
    _entry("vpn", aliases=("vpns",), display="VPN", category="security_governance"),
    _entry("firewalls", aliases=("firewall",), category="security_governance"),
    _entry("endpoint security", category="security_governance", kind="methodology"),
    _entry("disaster recovery", aliases=("disaster-recovery",), category="operations_support", kind="methodology"),
    _entry("patching", aliases=("patch management",), category="operations_support", kind="skill"),
    _entry("asset inventory", aliases=("asset management",), category="operations_support", kind="skill"),
