...
import { Download, FileCode2, FileText, Printer, ShieldCheck, ZoomIn, ZoomOut } from "lucide-react";
...
export function TemplatePreview({ artifact, text, latex = "", company, role, edited, resumeDocument, coverLetterDocument, onReturnToArtifact }: TemplatePreviewProps) {
