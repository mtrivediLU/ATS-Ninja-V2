    ...
    <div className="space-y-5">
      ...
      <Card>
        ...
        <p className="mt-2 text-sm text-ink-secondary">
          You can hold a capability a job asks for even when your resume uses different wording. Transfer is
          requirement-specific: each requirement is credited only from evidence for that exact requirement.
          Writing unit tests supports unit testing; it does not by itself support integration testing, API
          testing, test automation, or regression testing. A code review alone counts toward code review and
          general software quality, never toward automated testing. When a transfer is genuinely earned, it is
          surfaced as a truthful umbrella phrase (for example &ldquo;software testing and quality practices&rdquo;)
          that lifts your role alignment and is visible to a recruiter.
        </p>
        <p className="mt-2 text-sm text-ink-secondary">
          A transfer never invents a specific tool. A named tool or specialized testing type you do not have
          (for example Selenium, Cypress, or performance testing) stays an honest gap and is never added to your
          resume, and a transferable capability never earns strict exact-keyword credit.
        </p>
      </Card>
